...
import com.alekpeed.hearsay.core.data.eartraining.RoomEarTrainingRepository
...
abstract class DataModule {
    ...
    @Binds
    @Singleton
    abstract fun bindsEarTrainingRepository(impl: RoomEarTrainingRepository): EarTrainingRepository
}
